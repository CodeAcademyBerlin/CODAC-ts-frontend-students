...
const ProgressBar = ({ student }: { student: StudentEntity }) => {
  const theme = useTheme();
  return (
    <Box>
      {students
        ? students.data.map((student: StudentEntity, index: Index) => {
            const startingDate: Date = new Date(student.attributes?.start_date);
