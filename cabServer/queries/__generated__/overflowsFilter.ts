 ...
 * });
 */
export function useFilterCodacOverflowsQuery(
  baseOptions: Apollo.QueryHookOptions<
    FilterCodacOverflowsQuery,
    FilterCodacOverflowsQueryVariables
  >,
) {
  ...
  return Apollo.useQuery<
    FilterCodacOverflowsQuery,
    FilterCodacOverflowsQueryVariables
  >(FilterCodacOverflowsDocument, options);
}
export function useFilterCodacOverflowsLazyQuery(
...
export type FilterCodacOverflowsQueryHookResult = ReturnType<
  typeof useFilterCodacOverflowsQuery
>;
export type FilterCodacOverflowsLazyQueryHookResult = ReturnType<
  typeof useFilterCodacOverflowsLazyQuery
>;
export type FilterCodacOverflowsQueryResult = Apollo.QueryResult<
  FilterCodacOverflowsQuery,
  FilterCodacOverflowsQueryVariables
>;
...
export type FilterCodacOverflowsQuery = {
  __typename?: 'Query';
  codacOverflows?: {
