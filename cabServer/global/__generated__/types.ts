...
export type Mutation = {
  ...
  /**
   * update the corresponding battle with user voting option
   * remove the vote on the other option if present
   * remove the vote if voting the same option
   */
