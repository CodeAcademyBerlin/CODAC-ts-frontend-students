...
import { AchievementEntity, Student } from "../cabServer/global/__generated__/types";
...
const Dashboard = ({
  ...
  const achievements: AchievementEntity[] = data && data?.students?.data[0].attributes.achievements.data
