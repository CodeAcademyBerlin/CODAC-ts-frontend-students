  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ textAlign: "center" }}>Here you can ask questions, if you get stuck in your current project.<br></br>
      ...
      >
        ...
        >
          <form onSubmit={handleSearch}>
            <div>
              <TextField id="outlined-search" value={searchedTopic} label="Search for topics" name="search" type="search" onChange={(e) => {setSearchedTopic(e.target.value)} }/>
            </div>
          </form>
        </Box>

        <Stack spacing={2} style={{ margin: "10px 0px 10px 0px", display: "flex", justifyContent: "center", alignItems: "center" }}>
          {result && result.map((topic: CodacOverflowEntity) => (
            <Item
              ...
              <StyledLink href={`overflow/${topic.id}`}><h3 id="dynamic-overflow-link">{topic.attributes?.title}</h3></StyledLink>
